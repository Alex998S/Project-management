            ...
            <div className="container scrollable">
                <div className="ticket-form container border rounded scroll-size-80">
                    <form onSubmit={handleSubmit} className="d-flex flex-column">
                        <div className="">
                        <button className="btn btn-danger float-end m-2" type="button" onClick={()=>{setTicketToOpen(""); props.updateTicketToOpen("")}}>
                                Close
                            </button>
                            <button className="btn btn-success float-end m-2" type="submit">
                                Save
                            </button>
                        </div>
